...
export default function EmailSender() {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="email_card md:w-1/3 w-full mx-4 md:mx-0 bg-white dark:bg-gray-700 dark:text-white dark:border-none -mt-10 p-4 rounded-lg border shadow">
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className="input_field mt-4">
            ...
            type="text" id="large-input" placeholder="Enter Here" className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
          ...
          <div className="button_container flex justify-center gap-2 mt-4">
            <button
            disabled={sending}
            type="submit" className="hover:bg-blue-900 text-white bg-blue-700 px-3 py-2 rounded">Send Email</button>
